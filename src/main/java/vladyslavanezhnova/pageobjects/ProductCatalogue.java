...
public class ProductCatalogue extends AbstractComponent {
    ...
    By productsBy = By.cssSelector(".mb-3");// переменная productsBy является экземпляром класса By,
    // который можно использовать для многократного поиска элементов в различных частях кода.
